    ...
    <section id="chooseUs" class="flex flex-col items-center justify-center gap-5 py-10 px-5">
        ...
        <div class="grid grid-cols gap-2 md:grid-cols-2 lg:grid-cols-4">
            <div class=" bg-white flex shadow-xl rounded-3xl items-center justify-center gap-3 p-5 lg:p-7 lg:flex-col">
                ...
                <div>
                    <h1 class=" font-bold text-blue-900 text-base lg:text-lg lg:text-center">Harga Transparan & Kompetitif</h1>
                    <p class=" text-black text-xs lg:text-sm lg:text-center">Kami menawarkan harga yang jujur dan bersaing tanpa biaya tersembunyi, sehingga Anda bisa menikmati perjalanan dengan tenang.</p>
                </div>
            </div>
            <div class=" bg-white flex flex-row-reverse shadow-xl rounded-3xl items-center justify-center gap-3 p-5 lg:p-7 lg:flex-col">
                <img src="{{ url('img/car.png') }}" alt="" srcset="" class=" w-20 lg:w-30">
                <div>
                    <h1 class=" font-bold text-blue-900 text-base lg:text-lg lg:text-center">Armada Terawat & Beragam</h1>
                    <p class=" text-black text-xs lg:text-sm lg:text-center">Kami menyediakan berbagai jenis kendaraan, mulai dari city car hingga kendaraan premium, yang selalu dalam kondisi prima dan rutin diservis.</p>
                </div>
            </div>
            <div class=" bg-white flex shadow-xl rounded-3xl items-center justify-center gap-3 p-5 lg:p-7 lg:flex-col">
                ...
                <div>
                    ...
                    <p class=" text-black text-xs lg:text-sm lg:text-center">Tim kami siap memberikan layanan terbaik dengan respons cepat, ramah, dan profesional untuk memastikan kepuasan pelanggan.</p>
                </div>
            </div>
            <div class=" bg-white flex flex-row-reverse shadow-xl rounded-3xl justify-center items-center gap-3 p-5 lg:p-7 lg:flex-col">
                <img src="{{ url('img/fleksibel.png') }}" alt="" srcset="" class=" w-20 lg:w-30">
                <div>
                    <h1 class=" font-bold text-blue-900 text-base lg:text-lg lg:text-center">Fleksibilitas & Kemudahan</h1>
                    <p class=" text-black text-xs lg:text-sm lg:text-center">Proses pemesanan yang mudah dan fleksibel dengan berbagai pilihan
