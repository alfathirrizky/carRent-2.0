<div class="flex flex-col gap-5 bg-white rounded-2xl shadow-xl p-5">
    <img src="{{ $car['gambar_mobil'] }}" alt="">
    <div class="flex justify-between items-center">
        <h1 class=" text-2xl font-bold">{{ $car['nama_mobil'] }}</h1>
        <label class=" bg-blue-400 text-white font-medium p-1 px-6 text-xs rounded-2xl" for="">{{ $car['kategori']}}</label>
    </div>
    ...
    <div class=" flex justify-between">
        ...
        <button class=" text-sm bg-blue-700 text-white text-md font-medium px-5 py-1 rounded-2xl"> Book a car</button>
    </div>
</div>